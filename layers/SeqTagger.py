"""
Sequence tagger module
"""

from __future__ import print_function
from util import BIOF1Val
import keras
...
from .keraslayers.CRF import ChainCRF


class SeqTagger:
    def __init__(self, params=None):
        # modelSavePath = Path for storing models
        self.models = None
        self.modelSavePath = None
        self.resultsSavePath = None


        # Default hyperparameters for the network
    ...
    def computeF1(self, modelName, sentences):
        ...
        pre, rec, f1 = BIOF1Val.compute_f1(predLabels, correctLabels, idx2Label, 'O', encodingScheme)
        pre_b, rec_b, f1_b = BIOF1Val.compute_f1(predLabels, correctLabels, idx2Label, 'B', encodingScheme)
    ...
    def loadModel(modelPath):
        ...
        seqtagger = SeqTagger(params)
        seqtagger.setMappings(mappings, None)
        seqtagger.models = {modelName: model}
        seqtaggerlabelKeys = {modelName: labelKey}
        seqtagger.idx2Labels = {}
        seqtagger.idx2Labels[modelName] = {v: k for k, v in seqtagger.mappings[labelKey].items()}
        return seqtagger